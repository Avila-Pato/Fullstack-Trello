  ...
  return (
      ...
      <div className={cn("flex items-center justify-center flex-col",
        headingFont.className
         ...
         rounded-full uppercase">
          ...
          <div className="text-2xl md:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600
    ...
    <div className={cn(
     ...
     Colabora, gestiona proyectos y alcanza nuevos picos de productividad.
      Desde oficinas a rascacielos hasta tu hogar, cada equipo tiene su forma única de
       trabajar. ¡Logra todo esto con SyncTask!
      </div> 
      <Button className="mt-6" size="lg" asChild>
         <Link href="/sign-up">
         Obten SyncTask Gratis 
         </Link>
      </Button>
    </div>
  )
